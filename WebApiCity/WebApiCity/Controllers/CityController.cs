...
namespace WebApiCity.Controllers
{
    ...
    public class CityController : ControllerBase
    {
        ...
        public IActionResult RouteGet([FromRoute] string residentName, string cityName)
        {
        ...
        [HttpGet]
        [Route("/query")]
        public IActionResult QueryGet([FromQuery] string residentName, string cityName)
        {
